...
public class MenuSelectorModule extends ContainerWidget {
    ...
    private final Identifier SELECT_LEFT = new Identifier("horizoninmc", "selection/select_left");
    private final Identifier SELECT_RIGHT = new Identifier("horizoninmc", "selection/select_right");
    private final Identifier INVENTORY = new Identifier("horizoninmc", "navigator/inventory_text");
    private final Identifier INVENTORY_SEL = new Identifier("horizoninmc", "navigator/inventory_text_selected");
    private final Identifier MAP = new Identifier("horizoninmc", "navigator/map_text");
    private final Identifier MAP_SEL = new Identifier("horizoninmc", "navigator/map_text_selected");
    private final Identifier SKILLS = new Identifier("horizoninmc", "navigator/skills_text");
    private final Identifier SKILLS_SEL = new Identifier("horizoninmc", "navigator/skills_text_selected");
    private final Identifier QUESTS = new Identifier("horizoninmc", "navigator/quests_text");
    private final Identifier QUESTS_SEL = new Identifier("horizoninmc", "navigator/quests_text_selected");
    private final Identifier NOTEBOOK = new Identifier("horizoninmc", "navigator/notebook_text");
    private final Identifier NOTEBOOK_SEL = new Identifier("horizoninmc", "navigator/notebook_text_selected");
